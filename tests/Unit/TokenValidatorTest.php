...
class TokenValidatorTest extends TestCase
{
    ...
    public function validates(ExpressionRegistry $registry, array $tokens, int $expectedErrorCount): void
    {
        $tokenValidator = new TokenValidator($registry);
        $this->assertEquals($expectedErrorCount, count($tokenValidator->validate($tokens)));
    }
}
